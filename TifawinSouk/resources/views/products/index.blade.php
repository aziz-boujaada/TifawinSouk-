...
<body class="bg-gray-100">
    ...
    <header class="bg-gray-900 text-white shadow-md fixed w-full z-10">
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <a href="{{ route('products.create') }}" class="px-3 py-2 rounded-md bg-yellow-500 text-gray-900 hover:bg-yellow-400 transition">
                Add New Product
            </a>
        </div>
    </header>
                        ...
                        <tr class="hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-2">
                                    <a href="{{ route('products.show', $product) }}" class="bg-yellow-500 hover:bg-yellow-600 px-3 py-1 rounded text-white text-sm">View</a>
                                    <a href="{{ route('products.edit', $product) }}" class="bg-green-500 hover:bg-green-600 px-3 py-1 rounded text-white text-sm">Edit</a>
